...
```
> *Note: This command reads the outputs of `exp1`, computes the new parameters, uses the `ecearth-quests/ece4/duplicate-job.py` (https://github.com/asozza/ecearth-quests/tree/main) script to clone the environment into `exp2`, injects the new YAML, and automatically submits the job via `launch.sh`*
