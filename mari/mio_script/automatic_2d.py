...
results_root = f"../results/tuned_2d_LR/hybrid_test/{metric_to_test}/r2/net_toa_inc02/"
central_yaml_dir = os.path.join(results_root, "yaml_files")
log_dir = f"../results/logs/logs_2d_LR/hybrid_test/{metric_to_test}/r2/net_toa_inc02/"
